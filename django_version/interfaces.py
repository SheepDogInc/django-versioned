...
class VersionInterface(object):
    ...
    def set_version(self):
        try:
            ...
            return self.process_exception(e, 'set_version')
    ...
    def process_exception(self, exception, method):
            if self.fallback_interface is not None:
                return getattr(self.fallback_interface(), method)()
            else:
                raise exception
